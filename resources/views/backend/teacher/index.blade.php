...
@section('scripts')
    <script src="{{asset('backend/custom/teacher.js')}}"></script>
@endsection
@section('css')
    <style>
        .error{
                    ...
                    <form id="formAddTeacher">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="Nhập vào chức danh">
                            </div><!-- /.form-group -->
                            <div class="form-group">
                                <label for="birthday">Ngày sinh</label>
                                <input type="date" class="form-control" id="birthday" name="birthday" placeholder="Nhập vào ngày sinh">
                            </div><!-- /.form-group -->
                ...
                <div class="modal-body">
                    <form id="formEditTeacher">
                        ...
                        <fieldset>
                            ...
                            <label for="edit_title">Chức danh</label>
                                <input type="text" class="form-control" id="edit_title" name="title" placeholder="Nhập vào chức danh">
                            </div><!-- /.form-group -->
                            <div class="form-group">

                            <label for="edit_birthday">Ngày sinh</label>
                                <input type="date" class="form-control" id="edit_birthday" name="birthday" placeholder="Nhập vào ngày sinh">
                            </div><!-- /.form-group -->
